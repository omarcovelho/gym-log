...
import { History, Plus, X, Zap, AlertCircle, TrendingUp, FileText, Home, BookOpen, Copy } from 'lucide-react'
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#0f0f0f]/95 backdrop-blur-md border-t border-gray-800 md:hidden">
        <div className="max-w-6xl xl:max-w-7xl mx-auto flex items-center justify-around px-2 py-2">
          {/* Home */}
          <Link
            to="/app"
            className={`
