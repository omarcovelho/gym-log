...
export function FloatingActionButton() {
  ...
  return (
    <>
      {/* FAB Button - Fixo na parte inferior */}
      <div className="fixed bottom-6 right-6 z-50 group">
        ...
        <div className="flex flex-col items-center gap-2">
          <button
            ...
            className="w-14 h-14 md:w-16 md:h-16 bg-primary text-dark rounded-full shadow-lg shadow-primary/30 hover:shadow-primary/50 hover:scale-110 active:scale-95 transition-all flex items-center justify-center"
            aria-label="Iniciar treino"
            title="Iniciar Treino"
          >
            <Plus className="w-6 h-6 md:w-7 md:h-7" strokeWidth={2.5} />
          </button>
          {/* Label visível apenas no mobile */}
          <span className="text-xs font-semibold text-gray-300 md:hidden">Iniciar Treino</span>
        </div>
      </div>
