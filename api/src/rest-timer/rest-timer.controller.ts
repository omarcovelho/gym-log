...
export class RestTimerController {
  ...
  @ApiResponse({
    status: 200,
    description: 'List of timers returned successfully.',
  })
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden - Cannot edit default timers or timers owned by others.',
  })
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden - Cannot delete default timers or timers owned by others.',
  })
  @ApiResponse({ status: 404, description: 'Timer not found.' })
